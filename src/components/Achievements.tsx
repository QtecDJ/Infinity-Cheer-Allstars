      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-block bg-black border-8 border-brand-red px-10 py-4 mb-8">
            <h2 className="text-4xl font-black text-brand-red uppercase tracking-widest">Success</h2>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {achievements.map((achievement, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="bg-white border-8 border-black p-8 text-center shadow-xl hover:shadow-2xl transition-shadow"
            >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-brand-red to-red-800 border-8 border-black shadow-2xl overflow-hidden"
        >
          <div className="p-16">
            <div className="grid md:grid-cols-3 gap-12 text-center">
              ...
              >
                ...
                <div className="text-3xl font-black text-white uppercase tracking-wider">Teams</div>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="border-4 border-white p-8"
